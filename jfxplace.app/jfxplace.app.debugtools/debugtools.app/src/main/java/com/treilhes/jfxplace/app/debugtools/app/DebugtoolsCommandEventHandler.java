...
public class DebugtoolsCommandEventHandler implements CommandEventHandler {

private static final Logger logger = LoggerFactory.getLogger(DebugtoolsCommandEventHandler.class);
	...
	public DebugtoolsCommandEventHandler(
