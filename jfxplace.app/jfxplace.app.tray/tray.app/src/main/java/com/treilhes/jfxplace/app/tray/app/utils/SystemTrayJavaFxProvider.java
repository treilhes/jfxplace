package com.treilhes.jfxplace.app.tray.app.utils;
/*
...
public class SystemTrayJavaFxProvider implements Renderer {
    @Override
    ...
    public int getGtkVersion() {
        ...
        // JavaFX Java7,8 is GTK2 only. Java9 can MAYBE have it be GTK3 if
        // `-Djdk.gtk.version=3` is specified
        // see
        ...
        // HILARIOUSLY enough, you can use JavaFX + SWT..... And the javaFX GTK version
        // info SHOULD
        ...
        if (OS.INSTANCE.getJavaVersion() < 9) {
            // JavaFX from Oracle Java 8 is GTK2 only. Java9 can have it be GTK3 if
            // -Djdk.gtk.version=3 is specified
            // see http://mail.openjdk.java.net/pipermail/openjfx-dev/2016-May/019100.html
            return 2;
        }

        // Only possible Java9+ (so our case, Java11+ since 9 is no longer available, 11
        // is officially LTS)
